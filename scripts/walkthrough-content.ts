/**
 * The end-to-end walkthrough, as content.
 *
 * Held apart from either renderer so the printed sheet and the page somebody reads on a phone are
 * the same document. Two copies of a 38-step procedure is one copy that is wrong, and the wrong one
 * is always the one being followed.
 */
