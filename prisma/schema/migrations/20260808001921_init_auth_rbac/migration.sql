...
CREATE TABLE "ApprovalRule" (
    ...
    "key" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "primaryApproverRole" TEXT NOT NULL,
    "fallbackApproverRole" TEXT NOT NULL,
    "escalateAfterHours" INTEGER NOT NULL,
    "escalationMode" TEXT NOT NULL DEFAULT 'parallel',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ApprovalRule_key_key" ON "ApprovalRule"("key");
